...
const defaultWeddingInfo = {
  ...
  venueName: 'Chateau de la Belle Vue',
  ...
  dressCodeMen: 'A tuxedo is not necessary. A formal suit in dark colors is perfect. Tie or bow tie optional.',
  dressCodeWomen: 'Cocktail dress or long gown in soft, romantic colors. Avoid white, cream, or ivory.',
  weatherSeason: 'Early Summer',
  weatherAvgTemp: '20-25 C',
  ...
  parkingDescription: 'Free parking available at the venue.',
  ...
  giftPolicy: 'Your presence is the greatest gift.',
  ...
  transportNote: 'Shuttle service details will be sent via email.',
  updatedAt: new Date(),
  updatedBy: null,
};
...
export async function GET(request: Request) {
  try {
    ...
    if (!weddingInfo) {
      weddingInfo = await prisma.weddingInfo.create({
        data: {
          ...
          dressCodeTitle: 'Elegant & Romantic',
          dressCodeDescription: 'We want you to feel comfortable and beautiful on our special day. The dress code is elegant and romantic.',
          dressCodeMen: 'A tuxedo is not necessary. A formal suit in dark colors (black, navy, or charcoal) is perfect. Tie or bow tie optional.',
          dressCodeWomen: 'Cocktail dress or long gown in soft, romantic colors. Avoid white, cream, or ivory.',
          weatherSeason: 'Early Summer',
    ...
    return NextResponse.json(defaultWeddingInfo);
  }
}
