...
export function Footer() {
  return (
    <footer className="relative mt-20 overflow-hidden">
      ...
      <div className="absolute top-1/4 left-10 w-64 h-64 bg-gradient-to-br from-[var(--color-rose)]/5 to-transparent rounded-full blur-3xl" />
            ...
            <Link href="/" className="inline-flex flex-col items-center md:items-start group mb-6">
              <div className="flex items-center gap-3 mb-2">
                <motion.div
                  ...
                  className="relative"
                >
                  <Heart className="w-9 h-9 text-[var(--color-rose)] fill-current" />
                  <motion.div 
            ...
            <ul className="space-y-3">
              {quickLinks.map((link, index) => (
                ...
                >
                  <Link
                    href={link.href}
                    className="text-gray-600 hover:text-[var(--color-rose)] transition-all duration-300 inline-flex items-center gap-2 group text-sm font-light"
                  >
                    <motion.span 
            ...
            <div className="space-y-4 text-gray-600 text-sm">
              ...
              <div className="flex gap-3 justify-center md:justify-end mt-6 pt-4">
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-11 h-11 rounded-full bg-gradient-to-br from-[var(--color-rose)] to-[var(--color-secondary)] flex items-center justify-center text-white shadow-lg shadow-[var(--color-rose)]/20 hover:shadow-xl hover:shadow-[var(--color-rose)]/30 transition-all duration-300"
